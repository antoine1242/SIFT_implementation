...
def run():
    ...
    plt.savefig("./images_rapport/pyramide_de_gaussiennes_octave_" + str(octave + 1) + ".png")
    plt.show()
    ...
    plt.savefig("./images_rapport/difference_de_gaussiennes_octave_" + str(octave + 1) + ".png")
    plt.show()
